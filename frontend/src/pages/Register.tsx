    ...
    >
      ...
      <div className="relative w-full max-w-sm animate-scale-in">
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          <Link to="/home" className="flex flex-col items-center gap-3">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-[#64748b] mt-0.5">Create your account</p>
            </div>
          </Link>
        </div>
        ...
        >
          <div className="animate-fade-in">
            <div className="mb-6">
              ...
              <p className="text-sm text-[#64748b] mt-1">First user becomes admin automatically</p>
            </div>
        ...
        <p className="text-center text-xs text-[#475569] mt-5">
          ...
          <Link to="/login" className="text-[#818cf8] hover:text-[#a5b4fc] font-medium transition-colors">
            Sign in &rarr;
          </Link>
        </p>
      </div>
